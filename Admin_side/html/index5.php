...
<html dir="ltr" lang="en">
            ...
            <div class="col-12 d-flex no-block align-items-center">
              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="\PROJECT\Home_Page\index1.php">Home</a></li>
  ...
  <thead>
    <tr>
      ...
      <th scope="col"><b><u>User Name</u></b></th>
      <th scope="col"><b><u>Feedback</u></b></th>
  ...
  <?php
  $i=1;
  $sql=mysqli_query($con,"SELECT * FROM `feedback_details`");
