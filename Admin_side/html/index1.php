  ...
  <body>
    ...
    <div
      ...
      <div class="page-wrapper">
		...
		<h4 class="page-title">Admin Dashboard - Welcome <?php echo $r[2]; }?></h4>
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="E:\XAMPP NEW\htdocs\PROJECT\Home Page\index.php">Home</a></li>
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-success text-center">
				  ...
				  <?php 
				  $p=mysqli_query($con,"SELECT COUNT(booked) FROM `room_details` WHERE booked=1");
				  $a="";
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
				  ...
				  <?php 
				  $p=mysqli_query($con,"SELECT COUNT(booked) FROM `room_details` WHERE booked=0");
				  $a="";
				  while($row=mysqli_fetch_array($p))
				  {
					  $a=$row[0];
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-info text-center">
				  ...
				  <?php 
				  $p=mysqli_query($con,"SELECT COUNT(user_id) FROM `user_data` WHERE role=1");
				  $a="";
				  while($row=mysqli_fetch_array($p))
				  {
					  $a=$row[0];
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-warning text-center">
				  ...
				  <?php 
				  $p=mysqli_query($con,"SELECT COUNT(prop_id) FROM `property_detail`");
				  $a="";
				  while($row=mysqli_fetch_array($p))
				  {
					  $a=$row[0];
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-cyan text-center">
				  ...
				  <?php 
				  $p=mysqli_query($con,"SELECT COUNT(room_id) FROM `room_details`");
				  $a="";
				  while($row=mysqli_fetch_array($p))
				  {
					  $a=$row[0];
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-secondary text-center">
				  ...
				  <?php 
				  $p=mysqli_query($con,"SELECT COUNT(user_id) FROM `user_data` WHERE role=0");
				  $a="";
				  while($row=mysqli_fetch_array($p))
				  {
					  $a=$row[0];
				  ...
				  ?>
                  <h6 class="text-white">Total Guest</h6>
                  <h3 class="text-white"><?php echo $a; ?></h3>
                </div>
              </div>
            </div>
