...
<div class="shadow-lg p-3 mb-5 bg-body rounded" style="margin: 10rem auto; width: 50%;">
    ...
    <div class="row">
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    ...
                    <label class="form-label" for="UserName">Property Name</label>
                  </div>
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="text" id="Password" name="Name" class="form-control form-control-lg" />
    ...
    <input type="text" class="form-control" id="exampleInputName" aria-describedby="NameHelp">
                ...
                <div class="col-md-6 mb-4 d-flex align-items-center">
                  ...
                  <div class="form-outline datepicker w-100">
                    <input type="date" class="form-control form-control-lg" name="birthdayDate" id="birthdayDate" />
  ...
  <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="number" id="phoneNumber" name="phoneNumber" class="form-control form-control-lg" />
				...
				<div class="col-md-6 mb-4 pb-2">
	             ...
	             <div class="mb-4">
                    ...
                    <label class="Address" for="Name">Address</label>
                  </div>
</div>
